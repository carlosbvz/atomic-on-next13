...
export default function SkillExperienceLevelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new SkillExperienceLevel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SkillExperienceLevelCreateForm")}
      {...rest}
    >
      <SelectField
        label="Level"
